...
class SpeedClass(Hero):

	def __init__(self,name):
		super().__init__(name)
		self.health_pool = [0,100,150,250,300,400]
		self.attPower_pool = [0,20,40,60,80,100]
		self.armor_pool = [0,2,4,6,8,10]
		self.levelUp = 1

captain = CombatClass('Captain Amerika')
ironman = BlastClass('Ironman')
blackwidow = SpeedClass('Black Widow')

captain.show_info()
ironman.show_info()
blackwidow.show_info()

captain.gainExp = 200
ironman.gainExp = 250
blackwidow.gainExp = 250
